...
if args.text_path is not None and args.num_iterations > 0 and args.total_batch_size:
    from nanochat.dataloader import estimate_local_text_tokens
    est_tokens, n_docs = estimate_local_text_tokens(args.text_path, tokenizer)
    need_tokens = args.num_iterations * args.total_batch_size
